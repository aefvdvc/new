...
class cifar10_sampler(object):
    def __init__(self, data_path='datasets/cifar10'):
        # 自动下载和解压 CIFAR-10 数据集
        self.download_cifar10(data_path)
    ...
    def download_cifar10(self, data_path):
        ...
        if not os.path.exists(os.path.join(data_path, 'cifar-10-batches-py')):
            ...
            with open(os.path.join(data_path, 'cifar-10-python.tar.gz'), 'wb') as f:
...
class Mixture_sampler_v2(object):
    def __init__(self, nb_classes, N, dim, weights=None,sd=0.5):
        ...
        self.dim = dim
        np.random.seed(1024)
        #��� nb_classes <= dim�����ֵ�����ǰ nb_classes ��Ϊ��λ����
        #��� nb_classes > dim�����ֵ�����ǰ����Ϊ��λԲ�ϵĵ㣨�����ڶ�ά���ݣ�
        #��� dim == 2��ʹ�ü�����ķ�ʽ���ɾ�ֵ
        #��� dim > 2�����ֵ�����ǰ����ʹ�ü�����ķ�ʽ���ɣ������г�ʼ��Ϊ 0
        if nb_classes<=dim:
